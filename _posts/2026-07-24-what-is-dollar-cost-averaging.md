...
tags: [dollar cost averaging, investing, stock market, beginner investing, DCA]
description: "Dollar cost averaging is the simplest, most effective investing strategy for regular people. Here's exactly how it works, why it works, and how to set it up today."
image: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80&auto=format&fit=crop"
permalink: /investing/what-is-dollar-cost-averaging/
faq:
  - q: "What is dollar cost averaging in simple terms?"
    a: "Dollar cost averaging means investing a fixed dollar amount on a regular schedule — say, $100 every month — regardless of whether the market is up or down. When prices are high you buy fewer shares; when prices are low you buy more. Over time, your average cost per share ends up lower than if you tried to time your purchases perfectly."
  - q: "Is dollar cost averaging better than lump sum investing?"
    a: "For most people, yes — not because it produces mathematically higher returns (lump sum investing outperforms DCA about 2/3 of the time in backtests), but because DCA removes emotion from the equation. Investors who try to time the market almost always underperform a consistent monthly buyer. The best strategy is the one you'll actually stick to."
  - q: "How do I set up dollar cost averaging?"
    a: "Most brokerages (Fidelity, Vanguard, Schwab) let you set up automatic monthly investments into an index fund or ETF. Go to your account, find 'automatic investment' or 'recurring investment,' select your fund, enter the amount and frequency, and connect your bank account. The purchases happen automatically every month without you doing anything."
  - q: "What should I dollar cost average into?"
    a: "For most beginners, a total market index fund (like VTI, FSKAX, or VTSAX) or an S&P 500 index fund (like VOO or FXAIX) is the right choice. These are diversified, low-cost, and have historically returned 7–10% annually over long periods. Pick one fund, set up automatic monthly purchases, and leave it alone."
---
...
If you're investing inside a [Roth IRA](/investing/what-is-a-roth-ira/), the same fund choices apply — just set up the automatic investment inside the IRA account specifically.
...
*The [index funds beginner guide](/investing/index-funds-for-beginners/) and [emergency fund guide](/investing/how-much-emergency-fund/) cover the other two pieces of a complete investing foundation.*
